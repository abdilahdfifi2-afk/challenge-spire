  ...
  public: {
    Tables: {
      ...
      challenges: {
        ...
        Relationships: [
          {
            foreignKeyName: "challenges_creator_profile_fkey"
            columns: ["creator_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "challenges_opponent_profile_fkey"
            columns: ["opponent_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      tournament_participants: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tournament_participants_user_profile_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      _check_win_achievements: { Args: { _user: string }; Returns: undefined }
      _grant_achievement: {
